...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`DATING APPLICATIONS`}</title>

        <meta
          name="description"
          content="DATING APPLICATIONS: Redefining the boundaries of friendship, connect and engage in a unique four-way video experience."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1611679782010-5ac7ff596d9a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx2aWRlbyUyQmNoYXR8ZW58MHx8fHwxNjk4MTk4MzM5fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@goodfacesagency?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Good Faces`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`DATING APPLICATIONS: Redefining the boundaries of friendship, connect and engage in a unique four-way video experience.`}
            </Text>
            <Box
